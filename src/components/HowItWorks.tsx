    ...
    <section className="bg-neutral-900 px-6 py-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:divide-x md:divide-neutral-700">
          {STEPS.map((step, i) => (
            <div key={i} className="flex flex-col px-0 md:px-10 first:pl-0 last:pr-0 py-8 md:py-0 border-b border-neutral-700 md:border-b-0 last:border-b-0">
              <span className="text-6xl font-bold text-neutral-700 mb-6 leading-none">{step.number}</span>
