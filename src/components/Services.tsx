const SERVICES = [
  {
    ...
    price: "от 1 500 ₽",
    description:
      "Заправляем кондиционеры тракторов МТЗ, комбайнов и спецтехники хладагентом R134a. Перед заправкой обязательно проверяем систему на утечки — чтобы фреон не ушёл через неделю. Выезжаем прямо на поле или производственную базу.",
    points: [
      "Проверка давления и герметичности",
      "Заправка хладагентом R134a до нормы производителя",
      "Выезд по Курской, Белгородской, Орловской и Воронежской области",
    ],
  },
  {
    icon: "🔧",
